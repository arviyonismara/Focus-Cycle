<?php
$data = file_get_contents('data/fullbike.json');
$fullbike = json_decode($data, true);

$fullbike = $fullbike["menu"];
	...
	<div id="carouselExampleCaptions" class="carousel slide" data-bs-ride="carousel">
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<img src="img/carousel/fb.png" class="d-block w-100">
			</div>
		</div>
	</div>
